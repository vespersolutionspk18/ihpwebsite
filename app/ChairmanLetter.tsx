...
const ChairmanLetter = () => {
  return (
    <div className="p-10 md:p-10 mt-8 md:mt-16 flex flex-col md:flex-row gap-10 h-auto min-h-screen">
    <div className="px-0 md:px-10 w-full  md:w-1/2">
        <h3 className="font-sans font-medium text-gray-800 text-3xl md:text-4xl mb-5">
            Chairman&apos;s <span className="text-blue-800">Message</span>
        </h3>
        <p className="font-sans tracking-tight leading-tight font-light text-lg md:text-xl text-black text-justify">
    ...
    <div
        className="px-10 w-full md:w-1/2 bg-cover bg-center min-h-screen rounded-3xl"
